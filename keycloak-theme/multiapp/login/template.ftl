...
<#macro username>
  <div class="ma-account-summary" aria-label="${msg('maSignedInAs')} ${auth.attemptedUsername}">
    <div class="ma-account-copy">
      <span class="ma-account-label">${msg("maSignedInAs")}</span>
      <strong id="kc-attempted-username" class="ma-account-value">${auth.attemptedUsername}</strong>
    </div>
    <button id="reset-login" class="ma-account-change" type="button"
            onclick="location.href='${url.loginRestartFlowUrl}'">
      ${msg("maUseAnotherAccount")}
    </button>
  </div>
</#macro>
  ...
  <div class="${properties.kcLoginContainer!}">
    ...
    <main class="${properties.kcLoginMain!}">
      ...
      <div class="${properties.kcLoginMainBody!}">
        ...
        <#-- during login.                                                                               -->
        <#if displayMessage && message?has_content && message.type != 'info' && (message.type != 'warning' || !isAppInitiatedAction??)>
